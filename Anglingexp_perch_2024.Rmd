...
CPUE_data_perch<-AnglingClass_data_perch%>% # individual level data
  dplyr::select(Date,Site, Angler,Species, Fishing_experience,Species,Lure_color,
          Fishing_experience_score, Fishing_experience_standartized, Location, Session_ID,
          Duration_min)%>%
  mutate(id=row_number())%>%
  group_by(Date, Angler, Site, Lure_color, 
  ...
  distinct()%>%
  dplyr::select(Date:Duration_min,N_zero, N_fish, CPUE)
